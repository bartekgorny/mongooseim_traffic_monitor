...
var $author$project$Traffic$Closed = {$: 'Closed'};
var $author$project$Traffic$Empty = {$: 'Empty'};
var $author$project$Traffic$TimeZone = function (a) {
	return {$: 'TimeZone', a: a};
};
var $author$project$Traffic$WsAddr = function (a) {
	return {$: 'WsAddr', a: a};
};
...
var $author$project$Traffic$init = function (adr) {
	return _Utils_Tuple2(
		{
			announcement: $author$project$Traffic$Empty,
			conn_state: $author$project$Traffic$Closed,
			current_pid: '',
			mappings: $elm$core$Dict$empty,
			stanzas: _List_Nil,
			timezone: $elm$time$Time$utc,
			traced_pids: _List_Nil,
			tracing: false,
			ws_addr: $author$project$Traffic$WsAddr(adr)
		},
		A2($elm$core$Task$perform, $author$project$Traffic$TimeZone, $elm$time$Time$here));
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Traffic$RecEvent = function (a) {
	return {$: 'RecEvent', a: a};
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Traffic$incPort = _Platform_incomingPort('incPort', $elm$json$Json$Decode$value);
var $author$project$Traffic$subscriptions = function (_v0) {
...
var $author$project$Traffic$Failed = {$: 'Failed'};
...
var $author$project$Traffic$NewTrace = F4(
	function (pid, bare_jid, start_time, full_jid) {
		return {bare_jid: bare_jid, full_jid: full_jid, pid: pid, start_time: start_time};
	});
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$Traffic$newTraceDecoder = A5(
	...
	A2($elm$json$Json$Decode$field, 'start_time', $elm$json$Json$Decode$float),
...
var $author$project$Traffic$outPort = _Platform_outgoingPort(
	'outPort',
	function ($) {
		var a = $.a;
		var b = $.b;
...
var $author$project$Traffic$emptyPayload = $elm$json$Json$Encode$object(_List_Nil);
var $author$project$Traffic$simpleEvent = function (evt) {
	return _Utils_Tuple2(
		$elm$json$Json$Encode$string(evt),
		$author$project$Traffic$emptyPayload);
};
...
var $author$project$Traffic$handleEvent = F3(
	function (ename, v, model) {
		switch (ename) {
			case 'status':
				return A2($author$project$Traffic$handleStatus, v, model);
			case 'new_trace':
			...
			case 'connection_failed':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{conn_state: $author$project$Traffic$Failed}),
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
...
var $author$project$Traffic$SetWsAddr = function (a) {
	return {$: 'SetWsAddr', a: a};
};
...
var $author$project$Traffic$ChangeConnection = {$: 'ChangeConnection'};
var $author$project$Traffic$Skip = {$: 'Skip'};
var $author$project$Traffic$sendIfEnter = function (keycode) {
	if (keycode === 13) {
		return $author$project$Traffic$ChangeConnection;
	} else {
		return $author$project$Traffic$Skip;
	}
};
var $elm$html$Html$Attributes$type_ = $elm$html$Html$Attributes$stringProperty('type');
var $elm$html$Html$Attributes$value = $elm$html$Html$Attributes$stringProperty('value');
var $author$project$Traffic$showWsAddr = function (model) {
	var _v0 = model.ws_addr;
	var a = _v0.a;
	return A2(
		$elm$html$Html$input,
		_List_fromArray(
			[
				...
				function (s) {
					return $author$project$Traffic$SetWsAddr(
						$author$project$Traffic$WsAddr(s));
				}),
				A2(
				$elm$html$Html$Events$on,
				'keydown',
				A2($elm$json$Json$Decode$map, $author$project$Traffic$sendIfEnter, $elm$html$Html$Events$keyCode))
			]),
		_List_Nil);
};
...
var $author$project$Traffic$showConnState = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Traffic$showWsAddr(model),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$Traffic$viewAnnouncement = function (ann) {
	if (ann.$ === 'Empty') {
		...
		if (ann.a === 'too_many_traced_procs') {
			return A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$Traffic$mb_current = F2(
	function (curr_pid, pid) {
		return _Utils_eq(curr_pid, pid) ? 'current_pid' : '';
	});
...
var $author$project$Traffic$timeFormat = function (i) {
	return A3(
...
var $author$project$Traffic$showStartTime = F3(
	function (pid, mappings, tz) {
		var _v0 = A2($elm$core$Dict$get, pid, mappings);
		if (_v0.$ === 'Just') {
			var info = _v0.a;
			var t = $elm$time$Time$millisToPosix((info.start_time | 0) * 1000);
			return ',   ' + ($author$project$Traffic$timeFormat(
				A2($elm$time$Time$toHour, tz, t)) + (':' + ($author$project$Traffic$timeFormat(
				A2($elm$time$Time$toMinute, tz, t)) + (':' + $author$project$Traffic$timeFormat(
				A2($elm$time$Time$toSecond, tz, t))))));
		} else {
			return '';
		}
	});
var $author$project$Traffic$showJid = F4(
	function (curr_pid, mappings, tz, pid) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$class(
					A2($author$project$Traffic$mb_current, curr_pid, pid))
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$text(
							A3($author$project$Traffic$showStartTime, pid, mappings, tz))
						]))
				]));
	});
var $author$project$Traffic$viewJids = F4(
	function (curr_pid, traced_pids, mappings, tz) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Traced sessions:')
						])),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
					...
					A2(
						$elm$core$List$map,
						A3($author$project$Traffic$showJid, curr_pid, mappings, tz),
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A4($author$project$Traffic$viewJids, model.current_pid, model.traced_pids, model.mappings, model.timezone)
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
...
var $author$project$Traffic$main = $elm$browser$Browser$element(
	{init: $author$project$Traffic$init, subscriptions: $author$project$Traffic$subscriptions, update: $author$project$Traffic$update, view: $author$project$Traffic$view});
_Platform_export({'Traffic':{'init':$author$project$Traffic$main($elm$json$Json$Decode$string)(0)}});}(this));